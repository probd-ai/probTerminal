...
interface PerformanceChartProps {
  ...
  stats: {
    nifty_500: { cagr_pct: number; sharpe: number; max_drawdown_pct: number };
...
export default function PerformanceChart({ dates, nifty500, longOnly, longMeanRevert, stats }: PerformanceChartProps) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <ComposedChart data={data} margin={{ top: 10, right: 20, bottom: 40, left: 50 }}>
              <defs>
                <linearGradient id="gradNifty" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#999" stopOpacity={0.15} />
              ...
              <Line
                type="monotone"
                dataKey="nifty_500"
                name="NIFTY 500 Benchmark (12% CAGR)"
                stroke="#999"
                strokeWidth={1.5}
                strokeDasharray="4 4"
                dot={false}
              ...
              <Area
                ...
                name="Long Mean-Revert + F7 (28% CAGR)"
                fill="url(#gradLMR)"
                stroke="#14d9c4"
                strokeWidth={2.5}
                dot={false}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(140px,1fr))", gap: 12 }}>
        {[
          { name: "NIFTY 500", data: stats.nifty_500, color: "#999" },
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, fontSize: 11 }}>
              ...
              <div>
                <div style={{ color: "var(--text-3)", marginBottom: 2 }}>Max DD</div>
